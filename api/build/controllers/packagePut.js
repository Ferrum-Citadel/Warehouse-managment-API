...
var simulateDelivery = function (connection, voucher) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, mysql_1.Query(connection, query_1)];
            case 2:
                _a.sent();
...
var setEnRoute = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var connection, query, results, isScanned, isEnRoute, isDelivered, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 6, , 7]);
            ...
            case 2:
                ...
                return [4 /*yield*/, simulateDelivery(connection, req.params.voucher)];
            case 3:
...
var setDelivered = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var connection, query, results, isScanned, isEnRoute, isDelivered, driver, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 5, , 6]);
